...
| ------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------- |
| <img src="./public/assets/lighthouse/home.png" alt="Home Lighthouse 94 Score" width="400"> | <img src="./public/assets/lighthouse/projects.png" alt="Projects Lighthouse 99 Score" width="400"> |

| Experience Page                                                                                        | Contact Page                                                                                     |
| ------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------ |
| <img src="./public/assets/lighthouse/experience.png" alt="Experience Lighthouse 95 Score" width="400"> | <img src="./public/assets/lighthouse/contact.png" alt="Contact Lighthouse 93 Score" width="400"> |
